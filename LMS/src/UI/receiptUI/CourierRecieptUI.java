...
//import businesslogic.receiptbl.SendReceipt;
...
//		
//			Object[] options = {"确定"};
//			int response=JOptionPane.showOptionDialog(this, "提交成功", "提示",JOptionPane.OK_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
//			if(response==0){ 
//				System.exit(0);
//			}
//		}
